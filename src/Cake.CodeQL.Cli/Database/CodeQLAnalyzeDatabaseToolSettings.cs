...
public class CodeQLAnalyzeDatabaseToolSettings : CodeQLToolSettings
{
    ...
    /// <summary>
    /// Specify the format for the results file generated by the command. For upload to GitHub this should be: sarifv2.1.0
    /// </summary>
    /// <remarks>
    /// This is required. Defaults to sarifv2.1.0
    /// </remarks>
    public string Format { get; set; } = "sarifv2.1.0";
